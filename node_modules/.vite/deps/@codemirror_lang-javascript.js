  ...
  constructor(data, parser2, extraExtensions = [], name2 = "") {
    ...
    this.extension = [
      ...
      EditorState.languageData.of((state, pos, side) => {
        ...
        if (!data2)
          return [];
        let base2 = state.facet(data2), sub = top.type.prop(sublanguageProp);
        if (sub) {
...
var inputHandler2 = EditorView.inputHandler.of((view, from, to, insert) => {
...
function enumeratePropertyCompletions(obj, top) {
  ...
  for (let depth = 0; ; depth++) {
    for (let name2 of (Object.getOwnPropertyNames || Object.keys)(obj)) {
      ...
      options.push({
        label: name2,
        type: typeof value == "function" ? /^[A-Z]/.test(name2) ? "class" : top ? "function" : "method" : top ? "variable" : "property",
        boost: -depth
      });
    }
