<template>
  <div class="bg-black-800 py-10">
    <h2 class="text-2xl py-2 text-white font-bold">Delete Note</h2>
      ...
      <div class="flex flex-col space-y-6">
        <div class="text-white flex items-start">
          ...
          <span class="ml-4 py-2"
            >Set the endpoint to http://localhost:3000/delete-note</span
          >
        </div>
        <div class="text-white flex items-start">
          <span class="bg-amber-500 rounded py-2 px-3 text-white font-bold"
...
export default {
  ...
  data() {
    ...
    "id": "note-id"
      ...
      endpoint: "http://localhost:3000/delete-note",
      token: "",
      response: "",
    };
  },
